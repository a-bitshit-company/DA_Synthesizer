...
+ Einen Kippschalter besitzen, welcher es ermöglicht das Modul zu deaktivieren um die Stromversorgung zu entlasten
+ Mindestens eine Audiobuchse besitzen um CV, Audio, Triggersignale und andere Arten von Spannungssignalen auszugeben
+ ~13cm Hoch sind und ein Vielfaches von ~4.445cm breit sind, was im Eurorack format 1U entspricht
