...
\subsubsection{Schematics}
\label{sec:org16a3588}

\subsubsection{Benutzung}
\label{sec:org14edbbb}
...
\subsubsection{Elektronik}
\label{sec:orgc1af686}
\subsubsection{Schematics}
\label{sec:orgca5d983}
\begin{figure}[htbp]
\centering
...
\subsubsection{Spezifikationen}
\label{sec:orgab39fce}
\subsubsection{Elektronik}
\label{sec:orga637671}
...
\subsubsection{Schematics}
\label{sec:org75d4e68}
\subsubsection{Benutzung}
\label{sec:org2ff13e8}
...
\subsubsection{Spezifikationen}
\label{sec:org16659a4}
\subsubsection{Elektronik}
\label{sec:org778dc6e}
