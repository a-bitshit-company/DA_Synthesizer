...
Wir benutzen eine dünne, schwarz lackierte Holzplatte als Material für unsere Panels, diese bekleben wir mit transparenter Folie welche mit weißem Permanentmarker beschriftet werden kann.

\label{Osci}
\subsection{Oszillator x2}
\label{sec:org1f11c45}
...
\subsubsection{Schematics}
\label{sec:orgc517f96}

\subsubsection{Benutzung}
\label{sec:orgd4321b4}
...
\subsubsection{Elektronik}
\label{sec:orgcc09f7b}
\subsubsection{Schematics}
\label{sec:org5924f85}
\begin{figure}[htbp]
\centering
...
\end{figure}
\subsubsection{Benutzung}
\label{sec:org77f9e71}
Es können bis zu drei zu mixende Signale an die oberen Audiobuchsen angeschlossen werden. Die unteren beiden Audiobuchsen liefern das Ausgangssignal, wobei der rechte der invertierende Ausgang ist. Als einfachen Patch könnte man die beiden Signale des \href{modules/oscillator.org}{Oszillator x2} Moduls zusammenführen um beide Oszillatoren auf einmal zu hören.

\label{VCA}
\subsection{Spannungskontrollierter Verstärker}
\label{sec:org4ac88b7}
...
\subsubsection{Spezifikationen}
\label{sec:org9afa674}
\subsubsection{Elektronik}
\label{sec:orga837080}
...
\subsubsection{Schematics}
\label{sec:org165d77b}
\subsubsection{Benutzung}
\label{sec:org9f3cbbb}
...
\subsubsection{Spezifikationen}
\label{sec:orgeaf0cd7}
\subsubsection{Elektronik}
\label{sec:org97043e9}
