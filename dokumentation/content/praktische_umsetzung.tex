...
\label{sec:org889768d}
\subsubsection{Einleitende Beschreibung}
\label{sec:org9cfd20d}
...
\label{sec:org05279ab}
Resistor-Capacitor type Oszillator

\subsubsection{Schematics}
\label{sec:org4e40671}
...
(, )
\subsubsection{Spezifikationen}
\label{sec:orge7b9cf6}
\subsubsection{Elektronik}
\label{sec:org03db801}
...
\subsubsection{Elektronik}
\label{sec:orgb0c7ca4}
\subsubsection{Schematics}
\label{sec:org632cc9f}
\subsubsection{Benutzung}
\label{sec:org2927a90}
...
\subsubsection{Spezifikationen}
\label{sec:org8683be9}
\subsubsection{Elektronik}
\label{sec:org0afd29c}
...
\subsubsection{Schematics}
\label{sec:org3e06ef2}
\subsubsection{Benutzung}
\label{sec:org152d6b5}
...
\label{sec:org912b25b}
Der AR Hüllkurvengenerator stellt eine \href{file:///home/felixp/Documents/diplomarbeit/dokumentation/content/theoretische\_grundlagen.org}{Hüllkurve} bereit, wenn an seinem Kontrollspannungseingang ein Gate-Signal von etwa \SI{5}{\volt} anliegt. AR steht dabei für Attack-Release, das AR-Modul stellt somit eine einfache Variante des klassischen ADSR-Hüllkurvengenerators dar.

\subsubsection{Spezifikationen}
\label{sec:org5e93bb0}
\subsubsection{Elektronik}
\label{sec:org5d6e0bf}
\subsubsection{Schematics}
\label{sec:org410c3e8}
\subsubsection{Benutzung}
\label{sec:orgcdd64a1}
