...
\label{sec:org3358b59}
\subsubsection{Einleitende Beschreibung}
\label{sec:orgcfc0469}
...
\label{sec:orgc18259d}
Resistor-Capacitor type Oszillator

\subsubsection{Schematics}
\label{sec:org1864fcd}
...
(, )
\subsubsection{Spezifikationen}
\label{sec:org9189af2}
\subsubsection{Elektronik}
\label{sec:orge2d8aa7}
...
\subsubsection{Elektronik}
\label{sec:org51891c4}
\subsubsection{Schematics}
\label{sec:org7fed1d0}
\subsubsection{Benutzung}
\label{sec:org0313b5c}
...
\subsubsection{Spezifikationen}
\label{sec:orga9959d0}
\subsubsection{Elektronik}
\label{sec:orgc0af5f9}
\subsubsection{Schematics}
\label{sec:orgc30b28c}
\subsubsection{Benutzung}
\label{sec:org0f719dd}
...
\subsubsection{Spezifikationen}
\label{sec:org60cd30c}
\subsubsection{Elektronik}
\label{sec:orgaf63f13}
\subsubsection{Schematics}
\label{sec:orgce351c8}
\subsubsection{Benutzung}
\label{sec:org52de789}
