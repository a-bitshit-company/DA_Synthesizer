...
\label{sec:orgddccd72}
\subsubsection{Einleitende Beschreibung}
\label{sec:orga0c6d36}
...
\label{sec:orgb7e16ff}
Resistor-Capacitor type Oszillator

\subsubsection{Schematics}
\label{sec:orgaf85235}
...
\subsubsection{Elektronik}
\label{sec:org8e5c15f}
\subsubsection{Schematics}
\label{sec:orga1a1b6b}
\subsubsection{Benutzung}
\label{sec:orgadc1150}
...
\subsubsection{Spezifikationen}
\label{sec:orgfe87b4a}
\subsubsection{Elektronik}
\label{sec:orgcecb154}
...
\subsubsection{Spezifikationen}
\label{sec:orgef39c8f}
\subsubsection{Elektronik}
\label{sec:org9882fd2}
\subsubsection{Schematics}
\label{sec:org0428cbf}
\begin{circuitikz}[european]
\draw{
...
\label{sec:org7ec2bc9}
\subsubsection{Spezifikationen}
\label{sec:orgb82d1a8}
\subsubsection{Elektronik}
\label{sec:org4b8052e}
\subsubsection{Schematics}
\label{sec:orgee5a0fb}
\subsubsection{Benutzung}
\label{sec:org13a2118}
