...
\label{sec:org1f8db17}
Wie auf Abbildung \ref{fig:org9986c9f} zu erkennen ist, ist das Panel in einen linken und rechten Oszillator aufgeteilt. Alle Elemente auf einer Seite gehören zu jeweils einem Oszillator. Die oberen beiden Potentiometer dienen zur Steuerung der Frequenz (siehe Abschnitt \ref{frequenz}), die unteren beiden dienen zur Steuerung der Amplitude (siehe Abschnitt \ref{amplitude}) des Signals. Die Audiobuchsen dienen als Output. Der Schalter links oben aktiviert das Modul, die Oszillatoren sind nicht separat voneinander an- und ausschaltbar.
...
\caption{\label{fig:org9986c9f}Deckplatte unseres Oszillator-Moduls}
\end{figure}
...
\caption{\label{fig:org1d09c3d}Deckplatte unseres Noise-Moduls}
\end{figure}
...
\subsubsection{Spezifikationen}
\label{sec:org453ad70}
\subsubsection{Elektronik}
\label{sec:org61c7eea}
...
\subsubsection{Spezifikationen}
\label{sec:org51207b8}
\subsubsection{Elektronik}
\label{sec:orge388847}
