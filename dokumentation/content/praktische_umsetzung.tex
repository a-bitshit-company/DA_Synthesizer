...
\subsubsection{Schematics}
\label{sec:orgf4b15f9}

\subsubsection{Benutzung}
\label{sec:org83aa8e6}
...
\subsubsection{Elektronik}
\label{sec:orgf50c962}
\subsubsection{Schematics}
\label{sec:org5014438}
\begin{figure}[htbp]
\centering
...
\subsubsection{Spezifikationen}
\label{sec:orgdb71402}
\subsubsection{Elektronik}
\label{sec:org880784b}
...
\subsubsection{Schematics}
\label{sec:orgdae108a}
\subsubsection{Benutzung}
\label{sec:orgbb977d0}
...
\subsubsection{Spezifikationen}
\label{sec:org6c9c20f}
\subsubsection{Elektronik}
\label{sec:org2e2e626}
