...
\begin{figure}[htbp]
\centering
\includegraphics[angle=90,width=200px]{/home/felixp/Documents/diplomarbeit/dokumentation/figures/modules/noise.jpg}
\caption{Deckplatte unseres Noise-Moduls}
\end{figure}

\subsubsection{Spezifikationen}
\label{sec:orga3670e6}
Das Noise-Modul stellt weißes Rauschen in einem Bereich \SI{-3}{\volt} bs \SI{3}{\volt} bereit.

\subsubsection{Elektronik}
\label{sec:org42c4571}
\cite{miaw:noise}
\subsubsection{Schematics}
\label{sec:orgee03ccf}
\begin{circuitikz}[european]
\draw{
...
\begin{figure}[htbp]
\centering
\includegraphics[width=120px]{/home/felixp/Documents/diplomarbeit/dokumentation/figures/modules/mixer.jpg}
\caption{Deckplatte unseres Mixer-Moduls}
\end{figure}

\subsubsection{Spezifikationen}
\label{sec:org38c42ff}
...
\subsubsection{Elektronik}
\label{sec:orgddd6906}
\cite{miaw:mixer}
\subsubsection{Schematics}
\label{sec:orgc38fcc8}
...
\subsubsection{Spezifikationen}
\label{sec:org8423c41}
\subsubsection{Elektronik}
\label{sec:org4298f8a}
...
\subsubsection{Schematics}
\label{sec:orge5cba33}
\subsubsection{Benutzung}
\label{sec:orgc2892df}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=120px]{/home/felixp/Documents/diplomarbeit/dokumentation/figures/modules/LFO.jpg}
\caption{Deckplatte unseres LFO-Moduls}
\end{figure}


\subsubsection{Spezifikationen}
\label{sec:org2265150}
...
\subsubsection{Schematics}
\label{sec:org63d41ac}

\subsubsection{Benutzung}
\label{sec:org9b174b2}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=120px]{/home/felixp/Documents/diplomarbeit/dokumentation/figures/modules/AR.jpg}
\caption{Deckplatte unseres AR-Hüllkurvengenerator-Moduls}
\end{figure}

\subsubsection{Spezifikationen}
\label{sec:org360a167}
\subsubsection{Elektronik}
\label{sec:org4c7425d}
