...
\label{sec:org5a72972}
Wie auf Abbildung \ref{fig:org32de459} zu erkennen ist, ist das Panel in einen linken und rechten Oszillator aufgeteilt. Alle Elemente auf einer Seite gehören zu jeweils einem Oszillator. Die oberen beiden Potentiometer dienen zur Steuerung der Frequenz (siehe Abschnitt \ref{frequenz}), die unteren beiden dienen zur Steuerung der Amplitude (siehe Abschnitt \ref{amplitude}) des Signals. Die Audiobuchsen dienen als Output. Der Schalter links oben aktiviert das Modul, die Oszillatoren sind nicht separat voneinander an- und ausschaltbar.
...
\caption{\label{fig:org32de459}Deckplatte unseres Oszillator-Moduls}
\end{figure}
...
\caption{\label{fig:org07ea848}Deckplatte unseres Noise-Moduls}
\end{figure}
...
\subsubsection{Spezifikationen}
\label{sec:org988fd8d}
\subsubsection{Elektronik}
\label{sec:org0c83a7b}
...
\subsubsection{Spezifikationen}
\label{sec:org2848ad2}
\subsubsection{Elektronik}
\label{sec:orgb4c7c85}
