...
\caption{Der zeitliche Verlauf einer ADSR Hüllkurve; die Amplitudenwerte auf der Ordinate entsprechen bei einem Hüllkurvengenerator den ausgegebenen Kontrollspannungswerten  (Routenote, 2014)}
\end{figure}
\end{enumerate}

\subsubsection{Volt per Octave}
\label{sec:org888ae7c}
