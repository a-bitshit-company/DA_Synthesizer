...
\newcommand{\mytitle}{Diplomarbeit Modularer Synthesizer} 
...
\newcommand{\mysupervisor}{Cornelia Falch}  %%Betreuer. Bitte mit \\ Trennen wenn mehrere
...
\input{content/praktische_umsetzung}
...
\input{content/abkuerzungsverzeichnis}
\listoftables
\listoffigures
\lstlistoflistings
